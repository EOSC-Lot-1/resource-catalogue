...
//    private List<String> geographicalAvailabilities;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, resourceOrganisation, resourceProviders, authors, description, keywords, license, versionDate, targetGroups, learningResourceTypes, learningOutcomes, expertiseLevel, contentResourceTypes, qualifications, duration, languages, scientificDomains, contact, catalogueId);
    }
