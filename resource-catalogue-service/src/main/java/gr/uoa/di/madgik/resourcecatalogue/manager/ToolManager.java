...
//    }
    ...
    public ToolBundle add(ToolBundle toolBundle, Authentication auth) {
        ...
        toolBundle.setId(idCreator.generate(getResourceTypeName()));
    ...
    public ToolBundle getCatalogueResource(String catalogueId, String toolId, Authentication auth) {
        ...
        if (auth != null && auth.isAuthenticated()) {
            ...
            if (securityService.hasRole(auth, "ROLE_ADMIN") || securityService.hasRole(auth, "ROLE_EPOT") ||
                    securityService.userIsResourceProviderAdmin(user, toolId)) {
                return toolBundle;
            }
        }
...
//        }
    ...
    private long generateTimestampFromDate(String date) {
        long timestamp;
        try {
